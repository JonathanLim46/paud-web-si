                    ...
                    <div class="container-fluid">
                        <form class="d-flex" role="search">
                            <div class="search-container d-flex">
                                <input class="form-control me-2 rounded-pill search-bar" type="search"
                        ...
                        <ul class="navbar-nav ms-auto d-flex flex-row">
                            <li class="nav-item dropdown me-4">
                                <a class="nav-link dropdown-toggle d-flex align-items-center nav-profil" href="#"
                                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    @if (Auth::user()->image != null)
                                        <img src="{{ asset('storage/user/' . Auth::user()->id . '/' . Auth::user()->image) }}"
                                            alt="" class="img-profile me-3">
                                    @else
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('akun.edit', Auth::user()->id) }}">Ubah
                                            Akun</a></li>
                                    <li>
                                        <form action="{{ route('logout') }}" method="POST" class="dropdown-item"
                                            ...
                                            <a href="#"
                                                ...
                                                style="text-decoration: none; color: black;">Keluar</a>
                                        </form>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="container-fluid p-4">
                    <section class="mt-3 p-4 shadow-sm rounded-4" style="background-color: white;">
                        ...
                        <form action="{{ route('akun.update', $user->id) }}" method="POST"
                            class="form-edit-profile mt-4 w-50" id="form-edit" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mb-4 mt-4">
                                @if (old('image', $user->image) != null)
                                    <img src="{{ asset('storage/user/' . $user->id . '/' . $user->image) }}" alt=""
                                        id="img-edit">
                                @else
                                    <img src="{{ asset('images/dashboard/defaultImage.jpg') }}" alt=""
                                        id="img-edit">
                                @endif
                            ...
                            <div class="mb-4">
                                ...
                                <input type="username" class="form-control" id="username" name="username"
                                    placeholder="Masukkan username anda" value="{{ old('username', $user->username) }}"
                                    required>
                            </div>
                            <div class="mb-4">
                        ...
                        <button type="button" class="btn btn-outline-dark me-2 ps-3 pe-3"
