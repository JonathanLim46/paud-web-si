...
<div>
                ...
                <form wire:submit="search" class="search-form">
                    <div class="search-container">
                        <input type="text" wire:model.debounce.300ms="query" class="search-input"
                            placeholder="Cari nama guru" aria-label="Search" autocomplete="off">
    ...
    {{-- modal tambah guru --}}
    <div wire:ignore.self class="modal fade" id="modalTambahGuru" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="modalTambahGuruLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit="store">
                        <div class="mb-4">
                            @if ($imageGuru)
                                <img src="{{ $imageGuru->temporaryUrl() }}" class="img-thumbnail img-preview"
                                    alt="preview">
                            @else
                                <img src="{{ asset('images/dashboard/blankImage.jpg') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="usernameGuru" name="usernameGuru"
                                placeholder="Masukkan username guru" required wire:model="usernameGuru">
                            @error('usernameGuru')
                                <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="namaGuru" name="namaGuru"
                                placeholder="Masukkan nama guru" required wire:model="namaGuru">
                            @error('namaGuru')
                                <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" class="form-control" id="emailGuru" name="emailGuru"
                                placeholder="Masukkan Email Guru" required wire:model="emailGuru">
                            @error('emailGuru')
                                <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                        ...
                        <div class="mb-4">
                            ...
                            <select wire:model="jabatanGuru" class="form-select">
                                ...
                                <option value="Ketua Yayasan">Kepala Sekolah</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="alamat" name="alamat"
                                placeholder="Masukkan alamat" required wire:model="alamatGuru">
                            @error('alamatGuru')
                                <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
    ...
    {{-- modal edit guru --}}
    <div wire:ignore.self class="modal fade" id="modalEditGuru" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="modalEditGuruLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <form wire:submit="update({{ $selectedIdGuru->id_guru }})">
                            <div class="mb-4">
                                ...
                                @elseif($selectedIdGuru)
                                    <img src="{{ asset('storage/user/' . $selectedIdGuru->user->id . '/' . $selectedIdGuru->user->image) }}"
                                        class="img-thumbnail img-preview" alt="preview">
                                @else
                                    <img src="{{ asset('images/dashboard/blankImage.jpg') }}"
                                        class="img-thumbnail img-preview" alt="preview">
    ...
    {{-- modal delete  --}}
    <div wire:ignore.self class="modal fade" id="modalDeleteGuru" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="modalDeleteGuru" aria-hidden="true">
    ...
    {{-- modal filter --}}
    <div class="modal fade" id="filterGuruModal" tabindex="-1" aria-labelledby="filterGuruModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
