...
<div>
    ...
    <div class="row mt-4 pe-3 gy-4 row-cols-4">
        ...
        <div class="col">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalHapusFAQ"
                  wire:click="openModal({{ $faq->id }})">Hapus FAQ</a>
                  <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditFAQ"
                  wire:click="openModal({{ $faq->id }})">Perbarui FAQ</a>
                </div>
            </div>
        </div>
        @endforeach
        ...
        <!-- Modal Tambah FAQ -->
    <div wire:ignore.self class="modal fade" id="modalTambahFAQ" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalTambahFAQLabel" aria-hidden="true">
    ...
    <!-- Modal Edit FAQ -->
    <div wire:ignore.self class="modal fade" id="modalEditFAQ" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalEditFAQLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
              <div class="modal-content">
                <div class="modal-header">
    ...
    {{-- Modal Hapus Gambar --}}
    <div wire:ignore.self class="modal fade" id="modalHapusFAQ" tabindex="-1" aria-labelledby="modalHapusFAQLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body d-flex justify-content-center align-items-center">
                @if ($idFAQ)
                <form wire:submit="delete({{ $idFAQ->id }})" id="form-edit" enctype="multipart/form-data">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
