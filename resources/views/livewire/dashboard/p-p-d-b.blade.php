...
<div>
    <section class="mt-4 p-5 info-dashboard shadow-sm">
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-md-6 d-flex align-items-center">
                <a href="" data-bs-toggle="modal" data-bs-target="#filterModal" class="btn btn-secondary">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-12 d-flex justify-content-end">
                ...
                <div class="form-check form-switch ms-3 d-flex align-items-center">
                    <input wire:click="toggleSwitch" class="form-check-input custom-switch" type="checkbox"
                        id="customSwitch" @checked($isOn)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($pendaftar->diterima === 0)
                                    <a wire:click="openModal({{ $pendaftar->id_pendaftaran }})" class="btn btn-danger"
                                        data-bs-toggle="modal" data-bs-target="#modalDeletePendaftar">
                                        <i class="bi bi-eye me-1"></i>
                                        Hapus
                                    </a>
                                @endif
    ...
    {{-- modal delete  --}}
    <div wire:ignore.self class="modal fade" id="modalDeletePendaftar" data-bs-backdrop="static"
        data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalDeletePendaftar" aria-hidden="true">
